      ...
      <div id="content">
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="box">
                <h1>Configuration remise</h1>
                
                <form action="traitementRemise.php" method="GET">
                  <div class="form-group">
                    <label for="email">Montant</label>
                    <input name="montant" type="text" class="form-control">
                  </div>
                  <div class="form-group">
                    <label for="password">Remise</label>
                    <input name="remise" type="text" class="form-control">
                  </div>
                  <div class="text-center">
                    <button type="submit" class="btn btn-primary"><i class="fa fa-sign-in"></i> Valider</button>
                  </div>
                </form>
              </div>
            </div>
