      ...
      <div id="content">
        <div class="container">
          <div class="row">
            ...
            <hr><hr>
            <p><h2>Liste des medicaments</h2></p>
            <p>
            <table class="table">
                <tr>
                    <th scope="col">Id</th>
                    ...
                    <th scope="col">Mode Administration</th>
                    <th scope="col">Femme enceinte</th>
                    <th scope="col">Allaitement</th>
                    <th scope="col">Pour qui</th>
                </tr>
                <?php
                    while($donnee = mysqli_fetch_assoc($val)){
                ?>
                <tr>
                    <td scope="row"><?php echo $donnee['id'];?></td>
                    <td scope="row"><?php echo $donnee['reference'];?></td>
                    <td scope="row"><?php echo $donnee['nom'];?></td>
                    <td scope="row"><?php echo $donnee['categorie'];?></td>
                    <td scope="row"><?php echo $donnee['unite'];?></td>
                    <td scope="row"><?php echo $donnee['quantite'];?></td>
                    <td scope="row"><?php echo $donnee['descmedicament'];?></td>
                    <td scope="row"><?php echo $donnee['modeadministration'];?></td>
                    <td scope="row"><?php echo $donnee['femmeenceinte'];?></td>
                    <td scope="row"><?php echo $donnee['allaitement'];?></td>
                    <td scope="row"><?php echo $donnee['pourqui'];?></td>
                </tr>
                    <?php
    }
?>
