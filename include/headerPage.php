...
<header class="header mb-5">
      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container"><a href="../index.php?active=1" class="navbar-brand home"><img src="../assets/img/logo.png" alt="Obaju logo" class="d-none d-md-inline-block"><img src="../assets/img/logo-small.png" alt="pharmacie logo" class="d-inline-block d-md-none"><span class="sr-only">Obaju - go to homepage</span></a>
          ...
          <div id="navigation" class="collapse navbar-collapse">
                    ...
                    ?>
                      <div class="col-md-6 col-lg-3">
                        ...
                        <?php
                          ...
                          ?>
                          <li class="nav-item"><a href="categorie.php?idcat=<?php echo $donneecat['id'];?>&&idsouscat=<?php echo $donneesouscat['id'];?>&&active=2" class="nav-link"><?php echo $donneesouscat['nom'];?></a></li>
                        <?php
                        }
                        ?> 
                        </ul>
            ...
            <div class="navbar-buttons d-flex justify-content-end">
              ...
              ?>
               ...
               ?>
               <a href="traitement/traitementdeco.php" class="nav-link"><i class="fa fa-sign-out"></i>Deconnexion</a>
            </div>
          </div>
        </div>
      </nav>
